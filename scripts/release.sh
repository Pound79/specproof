...
echo "    npm view @pound79/specproof@$VERSION version             # expect $VERSION"
echo "    npm view @pound79/specproof-traceability@$VERSION version    # expect $VERSION"
echo "    gh release view $TAG                          # GitHub Release should be auto-created"
